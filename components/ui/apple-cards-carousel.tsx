  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-80 w-56 cursor-pointer flex-col items-start justify-start overflow-hidden rounded-3xl bg-neutral-900 transition-transform duration-300 ease-out hover:scale-[1.02] md:h-[40rem] md:w-96"
      >
